package adv_director.legacy.v0;

import java.util.ArrayList;
import net.minecraft.util.ResourceLocation;
import adv_director.api.enums.EnumLogic;
import adv_director.api.enums.EnumSaveType;
import adv_director.api.placeholders.rewards.RewardPlaceholder;
import adv_director.api.placeholders.tasks.TaskPlaceholder;
