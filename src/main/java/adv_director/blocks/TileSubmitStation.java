...
public class TileSubmitStation extends TileEntity implements IFluidHandler, ISidedInventory, ITickable, IFluidTankProperties
{
	...
	{
		return AdvDirector.submitStation.getLocalizedName();
	}
	...
	public void readFromNBT(NBTTagCompound tags)
	{
		...
		{
			AdvDirector.logger.log(Level.ERROR, "One or more tags were missing!", new Exception());
			this.reset();
		}
	}
	...
	{
		return new TextComponentString(AdvDirector.submitStation.getLocalizedName());
	}
