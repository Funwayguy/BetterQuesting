...
public class ToolboxGuiMain extends GuiElement implements IGuiEmbedded
{
	...
	public ToolboxGuiMain(IGuiQuestLine gui, int posX, int posY, int sizeX, int sizeY)
	{
		...
		btnOpen.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 112, 0, 16, 16, true);
		...
		btnNew.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 48, 16, 16, 16, true);
		...
		btnGrab.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 48, 0, 16, 16, true);
		...
		btnSnap = new GuiButtonThemed(2, posX + 36, posY + 36, (sizeX - 8)/2, 20, TextFormatting.BLACK.toString() + dragSnap, false);
		btnSnap.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 64, 0, 16, 16, true);
		...
		btnLink.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 80, 0, 16, 16, true);
		...
		btnCopy.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 32, 0, 16, 16, true);
		...
		btnRem.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 112, 16, 16, 16, true);
		...
		btnDel.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 16, 0, 16, 16, true);
		...
		btnCom.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 128, 0, 16, 16, true);
		...
		btnRes.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 128, 16, 16, 16, true);
		...
		btnIco.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 144, 0, 16, 16, true);
		...
		btnSca.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 144, 16, 16, 16, true);
		...
		btnRaw.setIcon(new ResourceLocation(AdvDirector.MODID + ":textures/gui/editor_icons.png"), 0, 0, 16, 16, true);
