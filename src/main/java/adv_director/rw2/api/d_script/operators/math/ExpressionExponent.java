...
public class ExpressionExponent implements IExpression<Number>
{
	private final IExpression<Number> e1;
	private final IExpression<Number> e2;
	
	public ExpressionExponent(IExpression<Number> e1, IExpression<Number> e2)
	{
		this.e1 = e1;
		this.e2 = e2;
	}
	...
	{
		return Math.pow(e1.eval(scope).doubleValue(), e2.eval(scope).doubleValue());
	}
