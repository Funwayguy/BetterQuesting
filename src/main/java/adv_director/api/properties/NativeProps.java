package adv_director.api.properties;

import net.minecraft.init.Items;
import net.minecraft.util.ResourceLocation;
import adv_director.api.enums.EnumLogic;
import adv_director.api.enums.EnumQuestVisibility;
import adv_director.api.properties.basic.PropertyTypeBoolean;
import adv_director.api.properties.basic.PropertyTypeEnum;
import adv_director.api.properties.basic.PropertyTypeItemStack;
import adv_director.api.properties.basic.PropertyTypeNumber;
import adv_director.api.properties.basic.PropertyTypeString;
...
public class NativeProps
{
	...
	public static final IPropertyType<String> HOME_IMAGE =					new PropertyTypeString(new ResourceLocation("betterquesting:home_image"), "adv_director:textures/gui/default_title.png");
