...
public class RunLengthCodec extends AbstractVideoCodec
{
	...
	public RunLengthCodec()
	{
		...
		}, new Format[]{new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_AVI, EncodingKey, ENCODING_AVI_RLE, DataClassKey, byte[].class, FixedFrameRateKey, true, DepthKey, 8), //
		});
	}
