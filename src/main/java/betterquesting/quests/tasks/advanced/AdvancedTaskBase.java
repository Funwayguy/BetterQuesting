...
public abstract class AdvancedTaskBase extends TaskBase
{
	...
	public void onBlockInteract(QuestInstance quest, EntityPlayer player, IBlockState state, BlockPos pos, boolean isPunch)
	{
		onBlockInteract(player, state, pos, isPunch);
	}
	...
	public void onNotePlayed(QuestInstance quest, World world, BlockPos pos, NoteBlockEvent.Instrument instrument, NoteBlockEvent.Note note, NoteBlockEvent.Octave octave) // Special event, combination lock?
	{
