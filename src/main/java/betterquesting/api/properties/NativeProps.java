...
public class NativeProps
{
	...
	@Deprecated
	public static final IPropertyType<Boolean> MAIN =						new PropertyTypeBoolean(new ResourceLocation("betterquesting:is_main"), false);
	public static final IPropertyType<Boolean> GLOBAL =						new PropertyTypeBoolean(new ResourceLocation("betterquesting:is_global"), false);
	public static final IPropertyType<Boolean> GLOBAL_SHARE =				new PropertyTypeBoolean(new ResourceLocation("betterquesting:global_share"), false);
	public static final IPropertyType<Boolean> SILENT =						new PropertyTypeBoolean(new ResourceLocation("betterquesting:is_silent"), false);
	public static final IPropertyType<Boolean> AUTO_CLAIM =					new PropertyTypeBoolean(new ResourceLocation("betterquesting:auto_claim"), false);
	public static final IPropertyType<Boolean> LOCKED_PROGRESS =			new PropertyTypeBoolean(new ResourceLocation("betterquesting:locked_progress"), false);
	...
	public static final IPropertyType<EnumLogic> LOGIC_TASK =				new PropertyTypeEnum<>(new ResourceLocation("betterquesting:task_logic"), EnumLogic.AND);
	public static final IPropertyType<EnumLogic> LOGIC_QUEST =				new PropertyTypeEnum<>(new ResourceLocation("betterquesting:quest_logic"), EnumLogic.AND);
	
	public static final IPropertyType<Integer> REPEAT_TIME =				new PropertyTypeInteger(new ResourceLocation("betterquesting:repeat_time"), -1);
	...
	public static final IPropertyType<Boolean> EDIT_MODE =					new PropertyTypeBoolean(new ResourceLocation("betterquesting:edit_mode"), true);
	public static final IPropertyType<Integer> LIVES =						new PropertyTypeInteger(new ResourceLocation("betterquesting:lives"), 1);
	public static final IPropertyType<Integer> LIVES_DEF =					new PropertyTypeInteger(new ResourceLocation("betterquesting:lives_def"), 3);
	public static final IPropertyType<Integer> LIVES_MAX =					new PropertyTypeInteger(new ResourceLocation("betterquesting:lives_max"), 10);
