...
public class ItemComparison {
    ...
    public static boolean CompareNBTTag(NBTBase tag1, NBTBase tag2, boolean partial) {
        ...
        } else if (tag1 instanceof NBTPrimitive
                && tag2 instanceof NBTPrimitive) // Standardize numbers to not care about format
        {
            ...
            if (tag1 instanceof NBTTagFloat
                    || tag1 instanceof NBTTagDouble
    ...
    private static boolean isEmptyNBT(NBTBase tag) {
        return tag == null
                || (tag instanceof NBTTagCompound && ((NBTTagCompound) tag).hasNoTags())
     ...
     */
    public static boolean OreDictionaryMatch(
            OreIngredient ore, NBTTagCompound tags, ItemStack stack, boolean nbtCheck, boolean partialNBT) {
