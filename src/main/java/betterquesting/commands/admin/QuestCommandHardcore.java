...
public class QuestCommandHardcore
{
    private static final String permNode = "betterquesting.command.admin.hardcore";
    
    public static ArgumentBuilder<CommandSource, ?> register()
    {
        return Commands.literal("hardcore").executes(QuestCommandHardcore::runCommand).then(Commands.argument("state", BooleanArgument.INSTANCE)).executes((source) -> runCommand(source, BooleanArgument.getValue(source, "state")));
    }
