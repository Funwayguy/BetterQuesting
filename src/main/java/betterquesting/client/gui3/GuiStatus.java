...
public class GuiStatus extends GuiScreenCanvas {
  ...
  public void initPanel() {
    ...
    CanvasTextured bgSideBar =
        new CanvasTextured(new GuiTransform(new Vector4f(0F, 0F, 0.2F, 1F), new GuiPadding(8, 24, 4, 24), 0),
    ...
    PanelButton btnEntry = new PanelButton(new GuiRectangle(0, 0, lw, 16, 0), 0, "Status");
    ...
    CanvasTextured bgQuickBar =
        new CanvasTextured(new GuiTransform(new Vector4f(0F, 1F, 0.2F, 1F), new GuiPadding(8, -24, 4, 8), 0),
                           PresetTexture.PANEL_INNER.getTexture());
    bgCan.addPanel(bgQuickBar);

    PanelButton btnSettings =
        new PanelButton(new GuiTransform(new Vector4f(0F, 0F, 0.25F, 1F), new GuiPadding(0, 0, 0, 0), 0), 0, "");
    btnSettings.setIcon(PresetIcon.ICON_GEAR.getTexture());
    bgQuickBar.addPanel(btnSettings);

    PanelButton btnParty =
        new PanelButton(new GuiTransform(new Vector4f(0.25F, 0F, 0.5F, 1F), new GuiPadding(0, 0, 0, 0), 0), 0, "");
    btnParty.setIcon(PresetIcon.ICON_PARTY.getTexture());
    bgQuickBar.addPanel(btnParty);

    PanelButton btnInbox =
        new PanelButton(new GuiTransform(new Vector4f(0.5F, 0F, 0.75F, 1F), new GuiPadding(0, 0, 0, 0), 0), 0, "");
    btnInbox.setIcon(PresetIcon.ICON_NOTICE.getTexture());
    bgQuickBar.addPanel(btnInbox);

    PanelButton btnTheme =
        new PanelButton(new GuiTransform(new Vector4f(0.75F, 0F, 1F, 1F), new GuiPadding(0, 0, 0, 0), 0), 0, "");
