...
public class ToolboxGuiMain extends GuiElement implements IGuiEmbedded
{
	...
	private final List<GuiButtonThemed> list = new ArrayList<>();
	...
	public static void drawGrid(CanvasQuestLine ui)
	{
		...
		int divX = (int)Math.floor(width / (zs * getSnapValue()));
		int divY = (int)Math.floor(height / (zs * getSnapValue()));
