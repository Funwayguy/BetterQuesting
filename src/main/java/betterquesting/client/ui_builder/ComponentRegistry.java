...
public class ComponentRegistry {
  ...
  private void init() {
    ...
    register(new ResourceLocation("betterquesting", "canvas_textured"),
             (rect, tag) -> new CanvasTextured(rect, PresetTexture.PANEL_MAIN.getTexture()), refTag);
    register(new ResourceLocation("betterquesting", "panel_button"),
             (rect, tag) -> new PanelButton(rect, -1, "New Button"), refTag);
  }
}
