...
public class GuiQuestLineAddRemove extends GuiScreenCanvas implements IPEventListener, IVolatileScreen, INeedsRefresh {
  ...
  public GuiQuestLineAddRemove(GuiScreen parent, @Nullable IQuestLine questLine) {
    ...
    lineID = QuestLineDatabase.INSTANCE.getID(questLine);
  }
  ...
  public void initPanel() {
                                           ...
                                           QuestTranslation.translate("betterquesting.title.edit_line2",
                                                                      questLine == null ? ""
                                                                                        : QuestTranslation.translate(
                                                                                            questLine.getUnlocalisedName()))).setAlignment(
        1);
    ...
    if (questLine != null) {
      PanelTextBox txtQuest = new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 0, 0, -16), 0),
                                               QuestTranslation.translate(questLine.getUnlocalisedName())).setAlignment(
    ...
    PanelTextField<String> searchBox =
        new PanelTextField<>(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 16, 8, -32), 0), "",
  ...
  private void refreshQuestList() {
    ...
    for (int i = 0; i < qles.size(); i++) {
      ...
      if (quest == null) {
        PanelButtonStorage<Integer> btnErr =
            new PanelButtonStorage<>(new GuiRectangle(width - 16, i * 16, 16, 16, 0), 6, "[ERROR]", entry.getID());
      ...
      PanelButtonStorage<DBEntry<IQuest>> btnEdit =
          new PanelButtonStorage<>(new GuiRectangle(0, i * 16, width - 16, 16, 0), 1,
      ...
      PanelButtonStorage<DBEntry<IQuest>> btnRem =
          new PanelButtonStorage<>(new GuiRectangle(width - 16, i * 16, 16, 16, 0), 3, "",
                                   new DBEntry<>(entry.getID(), quest));
