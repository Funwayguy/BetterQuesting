...
public class GuiQuestLinesEditor extends GuiScreenCanvas implements IPEventListener, IVolatileScreen, INeedsRefresh {
    ...
    public void initPanel() {
        ...
        PanelTextBox panTxt = new PanelTextBox(
                        ...
                        QuestTranslation.translate("betterquesting.title.edit_line1"))
                .setAlignment(1);
        ...
        tfName = new PanelTextField<>(
                new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 16, 0, -32), 0), "", FieldFilterString.INSTANCE);
        ...
        tfDesc = new PanelTextField<>(
                new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 48, 16, -64), 0), "", FieldFilterString.INSTANCE);
                ...
                new PanelButton(
                    ...
                    public void onButtonClick() {
                        ...
                        mc.displayGuiScreen(new GuiItemSelection(
                                GuiQuestLinesEditor.this, selected.getProperty(NativeProps.ICON), value -> {
    ...
    private void reloadList() {
        ...
        for (DBEntry<IQuestLine> entry : QuestLineDatabase.INSTANCE.getSortedEntries()) {
            ...
            lineList.addPanel(new PanelButtonStorage<>(new GuiRectangle(w - 16, i * 16, 16, 16, 0), 7, "", entry)
