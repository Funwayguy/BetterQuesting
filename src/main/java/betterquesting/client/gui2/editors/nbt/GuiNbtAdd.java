...
public class GuiNbtAdd extends GuiScreenCanvas implements IPEventListener, IVolatileScreen {
    ...
    public void initPanel() {
        ...
        PanelTextBox panTxt = new PanelTextBox(
                        ...
                        QuestTranslation.translate("betterquesting.title.json_add"))
                .setAlignment(1);
        ...
        if (nbt.getId() == 10) // NBTTagCompound
        {
            ...
            flKey = new PanelTextField<>(
                    new GuiTransform(GuiAlign.TOP_CENTER, -100, 48, 200, 16, 0), "", FieldFilterString.INSTANCE);
        ...
        // Standard Objects
        options.add(new PanelButtonStorage<>(
