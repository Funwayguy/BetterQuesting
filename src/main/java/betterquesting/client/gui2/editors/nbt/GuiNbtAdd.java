  ...
  public void initPanel() {
    ...
    if (nbt.getId() == 10) // NBTTagCompound
    {
      ...
      PanelTextBox txKeyTitle = new PanelTextBox(new GuiTransform(GuiAlign.TOP_CENTER, -100, 36, 200, 12, 0),
                                                 TextFormatting.RED +
                                                 QuestTranslation.translate("betterquesting.gui.no_key"));
    ...
    // Standard Objects
    options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, 0, 100, 16, 0), 2,
    ...
    CanvasScrolling cvOptions =
        new CanvasScrolling(new GuiTransform(new Vector4f(0.5F, 0F, 0.5F, 1F), new GuiPadding(-100, 64, -92, 32), 0));
    ...
    PanelVScrollBar scOptions =
        new PanelVScrollBar(new GuiTransform(new Vector4f(0.5F, 0F, 0.5F, 1F), new GuiPadding(92, 64, -100, 32), 0));
