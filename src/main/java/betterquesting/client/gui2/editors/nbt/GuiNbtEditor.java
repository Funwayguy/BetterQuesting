    ...
    public void initPanel() {
        ...
        PanelTextBox txTitle = new PanelTextBox(
                        ...
                        QuestTranslation.translate(
                                nbt.getId() == 9
                                        ? "betterquesting.title.json_array"
                                        : "betterquesting.title.json_object"))
                .setAlignment(1);
        ...
        PanelVScrollBar scEdit =
                new PanelVScrollBar(new GuiTransform(GuiAlign.RIGHT_EDGE, new GuiPadding(-24, 32, 16, 32), 0));
        ...
        PanelLine paLine1 =
                new PanelLine(ls1, le1, PresetLine.GUI_DIVIDER.getLine(), 1, PresetColor.GUI_DIVIDER.getColor(), -1);
