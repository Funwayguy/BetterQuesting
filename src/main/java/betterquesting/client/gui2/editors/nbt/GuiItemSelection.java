...
public class GuiItemSelection extends GuiScreenCanvas implements IPEventListener, IVolatileScreen {
    ...
    public void initPanel() {
        ...
        PanelTextBox txTitle = new PanelTextBox(
                        ...
                        QuestTranslation.translate("betterquesting.title.select_item"))
                .setAlignment(1);
        ...
        itemPreview =
                new PanelItemSlot(new GuiTransform(GuiAlign.TOP_LEFT, 0, 16, 36, 36, 0), 99, itemStack, false, true);
        ...
        btnOre = new PanelButtonStorage<>(
                new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(52, 36, 24, -52), 0), 2, "Ore: " + oreName, oreIdx);
        ...
        float iScale = Math.min(
                cvBottomLeft.getTransform().getWidth() / 162F,
        ...
        for (int i = 0; i < 27; i++) // Main inventory
        {
            ...
            cvBottomLeft.addPanel(new PanelItemSlot(
                    new GuiTransform(GuiAlign.TOP_LEFT, x, y, slotSize, slotSize, 0), 1, invoStack, true));
        }
