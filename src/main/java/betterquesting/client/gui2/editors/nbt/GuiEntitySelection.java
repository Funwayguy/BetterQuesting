...
public class GuiEntitySelection extends GuiScreenCanvas implements IPEventListener, IVolatileScreen {
    ...
    public void initPanel() {
        ...
        PanelTextBox txTitle = new PanelTextBox(
                        ...
                        QuestTranslation.translate("betterquesting.title.select_entity"))
                .setAlignment(1);
        ...
        CanvasEntityDatabase cvDatabase =
                new CanvasEntityDatabase(new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(0, 16, 8, 0), 0), 1);
        ...
        pnPreview = new PanelEntityPreview(
                new GuiTransform(GuiAlign.HALF_LEFT, new GuiPadding(16, 32, 8, 32), 0), selEntity);
        cvBackground.addPanel(pnPreview);

        pnPreview.setRotationDriven(new ValueFuncIO<>(() -> 15F), new ValueFuncIO<>(() ->
    ...
    private void onButtonPress(PEventButton event) {
        ...
        if (btn.getButtonID() == 0) // Exit
        {
            ...
            Entity e = EntityList.createEntityByName(
                    ((PanelButtonStorage<String>) btn).getStoredValue(), this.mc.theWorld);
