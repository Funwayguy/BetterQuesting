...
public class GuiImporters extends GuiScreenCanvas implements IPEventListener, ICallback<File[]> {
  ...
  public void initPanel() {
    ...
    impDescTX =
        new PanelTextBox(new GuiRectangle(0, 0, width, 16, 0), "", true).setColor(PresetColor.TEXT_MAIN.getColor());
  ...
  private void onButtonPress(PEventButton event) {
    ...
    } else if (btn.getButtonID() == 2) // Import
    {
      ...
      mc.displayGuiScreen(
          new GuiFileBrowser(this, this, new File(".").getAbsoluteFile().getParentFile(), lastImport.getFileFilter()));
    }
  }
