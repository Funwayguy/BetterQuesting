...
public class GuiImporters extends GuiScreenCanvas implements IPEventListener, ICallback<File[]> {
    ...
    public void initPanel() {
        ...
        PanelTextBox panTxt = new PanelTextBox(
                        ...
                        QuestTranslation.translate("betterquesting.title.importers"))
                .setAlignment(1);
        ...
        CanvasScrolling cvImports =
                new CanvasScrolling(new GuiTransform(GuiAlign.HALF_LEFT, new GuiPadding(16, 32, 16, 24), 0));
        ...
        for (int i = 0; i < impList.size(); i++) {
            ...
            cvImports.addPanel(new PanelButtonStorage<>(
    ...
    private void onButtonPress(PEventButton event) {
        ...
        } else if (btn.getButtonID() == 2) // Import
        {
            ...
            mc.displayGuiScreen(new GuiFileBrowser(
                    this, this, new File(".").getAbsoluteFile().getParentFile(), lastImport.getFileFilter()));
        }
    }
