...
public class GuiTaskEditor extends GuiScreenCanvas implements IPEventListener, IVolatileScreen, INeedsRefresh {
  ...
  public void initPanel() {
    ...
    PanelTextBox panTxt = new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 16, 0, -32), 0),
                                           QuestTranslation.translate("betterquesting.title.edit_tasks")).setAlignment(
        1);
    ...
    CanvasSearch<IFactoryData<ITask, NBTTagCompound>, IFactoryData<ITask, NBTTagCompound>> cvRegSearch =
        new CanvasSearch<IFactoryData<ITask, NBTTagCompound>, IFactoryData<ITask, NBTTagCompound>>(
    ...
    PanelTextField<String> tfSearch =
        new PanelTextField<>(new GuiTransform(new Vector4f(0.5F, 0F, 1F, 0F), new GuiPadding(8, 32, 16, -48), 0), "",
    ...
    PanelVScrollBar scTsk =
        new PanelVScrollBar(new GuiTransform(new Vector4f(0.5F, 0F, 0.5F, 1F), new GuiPadding(-16, 32, 8, 32), 0));
  ...
  private void onButtonPress(PEventButton event) {
    ...
    {
      IFactoryData<ITask, NBTTagCompound> fact =
          ((PanelButtonStorage<IFactoryData<ITask, NBTTagCompound>>) btn).getStoredValue();
