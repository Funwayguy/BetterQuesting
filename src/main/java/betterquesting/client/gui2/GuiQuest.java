  ...
  public void initPanel() {
    ...
    PanelTextBox panTxt = new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 16, 0, -32), 0),
                                           QuestTranslation.translate(
                                               quest.getProperty(NativeProps.NAME))).setAlignment(1);
    ...
    if (quest.getRewards().size() > 0) {
      CanvasScrolling cvDesc =
          new CanvasScrolling(new GuiTransform(new Vector4f(0F, 0F, 0.5F, 0.5F), new GuiPadding(0, 0, 16, 16), 0));
      cvInner.addPanel(cvDesc);
      PanelTextBox paDesc = new PanelTextBox(new GuiRectangle(0, 0, cvDesc.getTransform().getWidth(), 0),
      ...
      PanelVScrollBar paDescScroll = new PanelVScrollBar(
          new GuiTransform(GuiAlign.quickAnchor(GuiAlign.TOP_CENTER, GuiAlign.MID_CENTER),
                           new GuiPadding(-16, 0, 8, 16), 0));
      ...
      btnClaim = new PanelButton(new GuiTransform(new Vector4f(0F, 1F, 0.5F, 1F), new GuiPadding(16, -16, 24, 0), 0), 6,
                                 QuestTranslation.translate("betterquesting.btn.claim"));
      btnClaim.setActive(false);
      cvInner.addPanel(btnClaim);

      btnRewardLeft =
          new PanelButton(new GuiTransform(GuiAlign.BOTTOM_LEFT, new GuiPadding(0, -16, -16, 0), 0), 2, "<");
      btnRewardLeft.setActive(rewardIndex > 0);
      cvInner.addPanel(btnRewardLeft);

      btnRewardRight =
          new PanelButton(new GuiTransform(new Vector4f(0.5F, 1F, 0.5F, 1F), new GuiPadding(-24, -16, 8, 0), 0), 3,
                          ">");
      ...
      titleReward =
          new PanelTextBox(new GuiTransform(new Vector4f(0F, 0.5F, 0.5F, 0.5F), new GuiPadding(0, -16, 8, 0), 0), "?");
      ...
      CanvasScrolling cvDesc =
          new CanvasScrolling(new GuiTransform(GuiAlign.HALF_LEFT, new GuiPadding(0, 0, 16, 0), 0));
      cvInner.addPanel(cvDesc);
      PanelTextBox paDesc = new PanelTextBox(new GuiRectangle(0, 0, cvDesc.getTransform().getWidth(), 0),
                                             QuestTranslation.translate(quest.getProperty(NativeProps.DESC)), true);
      paDesc.setColor(PresetColor.TEXT_MAIN.getColor());//.setFontSize(4);
    ...
    //if(quest.getTasks().size() > 0)
    {
      ...
      btnTaskLeft =
          new PanelButton(new GuiTransform(new Vector4f(0.5F, 1F, 0.5F, 1F), new GuiPadding(8, -16, -24, 0), 0), 4,
                          "<");
      btnTaskLeft.setActive(taskIndex > 0);
      cvInner.addPanel(btnTaskLeft);

      btnTaskRight =
          new PanelButton(new GuiTransform(GuiAlign.BOTTOM_RIGHT, new GuiPadding(-16, -16, 0, 0), 0), 5, ">");
      ...
      titleTask =
          new PanelTextBox(new GuiTransform(new Vector4f(0.5F, 0F, 1F, 0F), new GuiPadding(8, 0, 0, -16), 0), "?");
