...
public class GuiQuestHelp extends GuiScreenCanvas {
    ...
    public void initPanel() {
        ...
        PanelTextBox panTxt = new PanelTextBox(
                        ...
                        QuestTranslation.translate("item.betterquesting.guide.name"))
                .setAlignment(1);
        ...
        CanvasScrolling cvDesc = new CanvasScrolling(
                        new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(124, 48, 24, 24), 0))
        ...
        PanelTextBox txtDesc =
                new PanelTextBox(new GuiRectangle(0, 0, cvDesc.getTransform().getWidth(), 16, 0), "", true);
