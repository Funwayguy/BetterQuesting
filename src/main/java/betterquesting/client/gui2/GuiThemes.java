...
public class GuiThemes extends GuiScreenCanvas {
    ...
    public void initPanel() {
        ...
        PanelTextBox panTxt = new PanelTextBox(
                        ...
                        QuestTranslation.translate("betterquesting.title.select_theme"))
                .setAlignment(1);
        ...
        for (int i = 0; i < themes.size(); i++) {
            ...
            PanelButtonStorage<ResourceLocation> pbs =
                    new PanelButtonStorage<>(trans, -1, theme.getName(), theme.getID());
            pbs.setCallback((res) -> {
        ...
        IGuiTexture icoSlides = new SlideShowTexture(
                ...
                new GuiTextureColored(
                        PresetTexture.QUEST_NORM_0.getTexture(), PresetColor.QUEST_ICON_LOCKED.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_NORM_1.getTexture(), PresetColor.QUEST_ICON_UNLOCKED.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_NORM_2.getTexture(), PresetColor.QUEST_ICON_PENDING.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_NORM_3.getTexture(), PresetColor.QUEST_ICON_COMPLETE.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_NORM_4.getTexture(), PresetColor.QUEST_ICON_REPEATABLE.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_MAIN_0.getTexture(), PresetColor.QUEST_ICON_LOCKED.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_MAIN_1.getTexture(), PresetColor.QUEST_ICON_UNLOCKED.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_MAIN_2.getTexture(), PresetColor.QUEST_ICON_PENDING.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_MAIN_3.getTexture(), PresetColor.QUEST_ICON_COMPLETE.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_MAIN_4.getTexture(), PresetColor.QUEST_ICON_REPEATABLE.getColor()),
                new GuiTextureColored(PresetTexture.QUEST_AUX_0.getTexture(), PresetColor.QUEST_ICON_LOCKED.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_AUX_1.getTexture(), PresetColor.QUEST_ICON_UNLOCKED.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_AUX_2.getTexture(), PresetColor.QUEST_ICON_PENDING.getColor()),
                new GuiTextureColored(
                        PresetTexture.QUEST_AUX_3.getTexture(), PresetColor.QUEST_ICON_COMPLETE.getColor()));
        ...
        itemFrame.addPanel(new PanelGeneric(
