...
public class GuiPartyCreate extends GuiScreenCanvas implements IPEventListener, INeedsRefresh
{
    ...
    private void refreshInvites()
    {
        ...
        int elSize = RenderUtils.getStringWidth("...", mc.fontRendererObj);
        ...
        for(int i = 0; i < invites.size(); i++)
        {
            ...
            if(RenderUtils.getStringWidth(pName, mc.fontRendererObj) > cvWidth - 58)
            {
                pName = mc.fontRendererObj.trimStringToWidth(pName, cvWidth - 58 - elSize) + "...";
            }
