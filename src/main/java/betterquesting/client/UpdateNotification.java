...
public class UpdateNotification
{
	...
	public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event)
	{
		...
		{
			event.player.sendMessage(new TextComponentString(TextFormatting.RED + "THIS COPY OF " + BetterQuesting.NAME.toUpperCase() + " IS NOT FOR PUBLIC USE!"));
			return;
		}
		...
		try
		{
			...
			{
				event.player.sendMessage(new TextComponentString(TextFormatting.RED + "An error has occured while checking " + BetterQuesting.NAME + " version!"));
			...
			if(hasUpdate)
			{
				event.player.sendMessage(new TextComponentString(TextFormatting.RED + "Update for " + BetterQuesting.NAME + " available!"));
				event.player.sendMessage(new TextComponentString("Download: http://minecraft.curseforge.com/projects/better-questing"));
