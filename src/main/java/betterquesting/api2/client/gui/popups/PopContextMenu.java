        ...
        for (int i = 0; i < category.entries.size(); i++) {
            ...
            if (entry.icon != null) {
                ...
                PanelButton eBtn = new PanelButton(
                        new GuiRectangle(16, i * 16, rect.w - 24, 16, 0), -1, QuestTranslation.translate(entry.text));
                ...
                PanelButton eBtn = new PanelButton(
                        new GuiRectangle(0, i * 16, rect.w - 8, 16, 0), -1, QuestTranslation.translate(entry.text));
                if (entry.action != null) {
                    eBtn.setClickAction((b) -> entry.action.run());
                } else {
                    eBtn.setActive(false);
