...
public class PanelPlayerPortrait implements IGuiPanel {
  ...
  public void drawPanel(int mx, int my, float partialTick) {
    ...
    RenderUtils.RenderEntity(bounds.getX() + bounds.getWidth() / 2f,
                             bounds.getY() + bounds.getHeight() / 2f + (int) (scale * 1.5F), zDepth, scale,
                             yawDriver.readValue(), pitchDriver.readValue(), player);
