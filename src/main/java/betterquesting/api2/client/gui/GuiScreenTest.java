...
public class GuiScreenTest extends GuiScreenCanvas {
  ...
  public void initPanel() {
    ...
    phf.setFillColor(
        new GuiColorTransition(new GuiColorStatic(0xFFFF0000), new GuiColorStatic(0xFF00FF00)).setupBlending(true,
                                                                                                             0.25F));
    cvt1.addPanel(phf);
    ...
    GuiColorTransition transColor =
        new GuiColorTransition(new GuiColorStatic(0xFF00FF00), new GuiColorStatic(0xFFFF0000)).setupBlending(true,
                                                                                                             0.25F);
