...
public class GuiScreenTest extends GuiScreenCanvas {
    ...
    public void initPanel() {
        ...
        phf.setFillColor(new GuiColorTransition(new GuiColorStatic(0xFFFF0000), new GuiColorStatic(0xFF00FF00))
        ...
        pvf.setFillColor(new GuiColorTransition(new GuiColorStatic(0xFFFF0000), new GuiColorStatic(0xFF00FF00))
                .setupBlending(true, 0.25F));
        cvt1.addPanel(pvf);

        IValueIO<Float> fillDriver =
                new ValueFuncIO<>(() -> (int) Math.abs(System.currentTimeMillis() % 5000L - 2500L) / 2500F);

        GuiColorTransition transColor = new GuiColorTransition(
                        new GuiColorStatic(0xFF00FF00), new GuiColorStatic(0xFFFF0000))
                .setupBlending(true, 0.25F);
