    ...
    public void drawTexture(int x, int y, int width, int height, float zLevel, float partialTick, IGuiColor color) {
        ...
        if (sliceMode == SliceMode.SLICED_TILE) {
            ...
            GuiUtils.drawTexturedModalRect(
                    0, 0, texBounds.getX(), texBounds.getY(), texBorder.getLeft(), texBorder.getTop(), zLevel);
            GL11.glPopMatrix();
            ...
            GuiUtils.drawTexturedModalRect(
                    0, 0, texBounds.getX() + texBorder.getLeft(), texBounds.getY(), iw, texBorder.getTop(), zLevel);
            GL11.glPopMatrix();
            ...
            GuiUtils.drawTexturedModalRect(
                    0, 0, texBounds.getX(), texBounds.getY() + texBorder.getTop(), texBorder.getLeft(), ih, zLevel);
            GL11.glPopMatrix();
            ...
            Minecraft.getMinecraft().renderEngine.bindTexture(texture);
            GuiUtils.drawTexturedModalRect(
                    0, 0, texBounds.getX(), texBounds.getY(), texBounds.getWidth(), texBounds.getHeight(), zLevel);
        }
