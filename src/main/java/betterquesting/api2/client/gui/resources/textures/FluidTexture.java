...
public class FluidTexture implements IGuiTexture {
    ...
    public void drawTexture(int x, int y, int width, int height, float zDepth, float partialTick, IGuiColor color) {
        ...
        IIcon icon = fluid.getFluid().getIcon() != null
    ...
    private void drawTexturedModalRect(
            double xCoord, double yCoord, double zDepth, IIcon textureSprite, double widthIn, double heightIn) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(
                xCoord, yCoord + heightIn, zDepth, textureSprite.getMinU(), textureSprite.getMaxV());
        tessellator.addVertexWithUV(
                xCoord + widthIn, yCoord + heightIn, zDepth, textureSprite.getMaxU(), textureSprite.getMaxV());
