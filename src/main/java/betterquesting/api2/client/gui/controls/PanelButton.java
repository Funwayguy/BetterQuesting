...
public class PanelButton implements IPanelButton {
    ...
    public PanelButton(IGuiRect rect, int id, String txt) {
        ...
        this.setTextHighlight(
                PresetColor.BTN_DISABLED.getColor(), PresetColor.BTN_IDLE.getColor(), PresetColor.BTN_HOVER.getColor());
    }
    ...
    private static void drawCenteredString(
            FontRenderer font, String text, int x, int y, int width, int color, boolean shadow, int align) {
        switch (align) {
            case 0: {
            ...
            default: {
                font.drawString(
                        ...
                        MathHelper.floor_float(
                                x + Math.floorDiv(width, 2) - RenderUtils.getStringWidth(text, font) / 2F),
                        y,
                        color,
                        shadow);
            }
