...
public class EventHandler
{
	...
	public void onKey(InputEvent.KeyInputEvent event)
	{
		...
		{
			if(mc.thePlayer.isSneaking() && mc.thePlayer.getName().equalsIgnoreCase("Funwayguy"))
			{
	...
	public void onLivingUpdate(LivingUpdateEvent event)
	{
		...
		if(event.getEntityLiving() instanceof EntityPlayer)
		{
            ...
            {
                long totalTime = player.getServer().worldServerForDimension(0).getTotalWorldTime();
	...
	{
		if(event.player.worldObj.isRemote || event.player.getServer() == null || !(event.player instanceof EntityPlayerMP))
		{
			return;
