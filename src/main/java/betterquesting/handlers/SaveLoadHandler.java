...
public class SaveLoadHandler {
  public static final SaveLoadHandler INSTANCE = new SaveLoadHandler();
  ...
  public void loadDatabases(MinecraftServer server) {
    ...
    if (!cVer.equalsIgnoreCase(bVer) && !useDef) // RUN BACKUPS
    {
      ...
      JsonHelper.CopyPaste(fileDatabase, new File(BQ_Settings.curWorldDir + "/backup/" + fsVer,
                                                  "QuestDatabase_backup_" + fsVer + ".json"));
      JsonHelper.CopyPaste(fileProgress, new File(BQ_Settings.curWorldDir + "/backup/" + fsVer,
                                                  "QuestProgress_backup_" + fsVer + ".json"));
      JsonHelper.CopyPaste(fileParties, new File(BQ_Settings.curWorldDir + "/backup/" + fsVer,
                                                 "QuestingParties_backup_" + fsVer + ".json"));
      JsonHelper.CopyPaste(fileNames, new File(BQ_Settings.curWorldDir + "/backup/" + fsVer,
                                               "NameCache_backup_" + fsVer + ".json"));
      JsonHelper.CopyPaste(fileLives, new File(BQ_Settings.curWorldDir + "/backup/" + fsVer,
                                               "LifeDatabase_backup_" + fsVer + ".json"));
    }
  ...
  public void saveDatabases() {
    ...
    if (isDirty || QuestSettings.INSTANCE.getProperty(NativeProps.EDIT_MODE)) {
      ...
      JsonHelper.WriteToFile(new File(BQ_Settings.curWorldDir, "QuestDatabase.json"),
                             NBTConverter.NBTtoJSON_Compound(jsonCon, new JsonObject(), true));
    }
    ...
    JsonHelper.WriteToFile(new File(BQ_Settings.curWorldDir, "QuestProgress.json"),
                           NBTConverter.NBTtoJSON_Compound(jsonProg, new JsonObject(), true));
    ...
    JsonHelper.WriteToFile(new File(BQ_Settings.curWorldDir, "QuestingParties.json"),
                           NBTConverter.NBTtoJSON_Compound(jsonP, new JsonObject(), true));
    ...
    JsonHelper.WriteToFile(new File(BQ_Settings.curWorldDir, "NameCache.json"),
                           NBTConverter.NBTtoJSON_Compound(jsonN, new JsonObject(), true));
    ...
    JsonHelper.WriteToFile(new File(BQ_Settings.curWorldDir, "LifeDatabase.json"),
                           NBTConverter.NBTtoJSON_Compound(jsonL, new JsonObject(), true));
